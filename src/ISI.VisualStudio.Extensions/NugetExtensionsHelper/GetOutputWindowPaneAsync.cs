...
namespace ISI.VisualStudio.Extensions
{
	public partial class NugetExtensionsHelper
	{
		...
		{
			return _outputWindowPane ??= await Community.VisualStudio.Toolkit.VS.Windows.CreateOutputWindowPaneAsync("ISI.VisualStudio.Extensions.NugetExtensionsHelper");
		}
	}
}
